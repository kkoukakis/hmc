 <div class="navbar">
     ...
     <li><a  href="index.php" class="">Oasa.gr</a></li>
	...
	<ul class="nav navbar-nav navbar-right">
     <li><input id="search" type="text" placeholder="Search..." height="20"/><img src="components\navbar\English-Language-Flag-1-icon.png" title="English" height="20" width="20"></li>
	...
	<li><a href="login.php"    class="">Σύνδεση</a></li>
	<li><a href="register.php" class="">Εγγραφή</a></li>
	</ul>
 </div>

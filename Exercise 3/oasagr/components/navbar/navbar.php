<nav>
     ...
     <?php if(isset($_SESSION['type'])){ echo("<li><a href=\"favorites.php\"       class=\"d\"> <img class=\"img-invert\" src=\"components\\navbar\heart.png\" title=\"favorites\" height=\"20\" width=\"20\" style=\"padding-top: 8px;\"> Αγαπημένα </a></li>
	<li><a href=\"scripts\logout.php\"    class=\"d\">Αποσύνδεση</a></li>");}else{echo("<li><a href=\"login.php\"       class=\"d\"> <img class=\"img-invert\" src=\"components\\navbar\login.png\" title=\"login\" height=\"20\" width=\"20\" style=\"padding-top: 8px;\"> Σύνδεση </a></li>

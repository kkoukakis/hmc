                    ...
                    <div class="accordion" id="accordion-tab-1">
                        <div class="card">
                            <div class="card-header" id="accordion-tab-1-heading-1">
                                <h5>
                                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-1-content-1" aria-expanded="false" aria-controls="accordion-tab-1-content-1">Τι είδους εισιτήριο δικαιούμαι;</button>
                                </h5>
                            </div>
                            <div class="collapse show" id="accordion-tab-1-content-1" aria-labelledby="accordion-tab-1-heading-1" data-parent="#accordion-tab-1">
                                <div class="card-body">
                                    <p>Μειωμένα εισιτήρια δικαιούνται οι φοιτητές, άνθρωποι χρυσης ηλικίας κλπ</p>
                                </div>
                            </div>
                        </div>
                        <div class="card">
